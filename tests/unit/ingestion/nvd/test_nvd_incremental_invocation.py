...
class NvdIncrementalRuntimeSettingsV1:
    ...
    DEFAULT_BRONZE_PREFIX = "bronze/nvd/cve/updates"
    DEFAULT_CVE_API_BASE_URL = (
        "https://services.nvd.nist.gov/rest/json/cves/2.0"
    )
    DEFAULT_CVE_API_TIMEOUT_SECONDS = 30.0
    DEFAULT_CVE_API_MAX_RESPONSE_BYTES = 16 * 1024 * 1024
    DEFAULT_CVE_API_MINIMUM_INTERVAL_SECONDS = 6.0
    DEFAULT_CVE_API_MAX_ATTEMPTS = 3
    ...
    def from_environment(cls) -> "NvdIncrementalRuntimeSettingsV1":
        ...
        try:
            ...
            raise NvdIncrementalRuntimeConfigurationError(
                "NVD incremental runtime environment configuration is invalid."
            ) from exc
