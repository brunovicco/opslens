...
def _verify_architecture_and_portfolio() -> None:
    ...
    _require(
        architecture_pt,
        f"As Phases 0{EN_DASH}18 estão completas.",
        "Phase 19 — Bounded Public Runtime & Productization",
        "```mermaid",
...
def _verify_reviewer_assets() -> None:
    ...
    _require(
        _read("walkthrough"),
        f"3{EN_DASH}5 Minute Reviewer Walkthrough",
        "material-vulnerability",
        "controlled-benign",
        "fail-closed-incomplete-evidence",
        "17,748 ms MEASURED",
