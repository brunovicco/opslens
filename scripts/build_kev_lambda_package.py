"""Build the deterministic AWS Lambda deployment package for KEV ingestion."""
...
BUILD_DIR = PROJECT_ROOT / "build" / "lambda" / "kev-ingestion"
PACKAGE_DIR = BUILD_DIR / "package"
REQUIREMENTS_FILE = BUILD_DIR / "requirements.txt"

DIST_DIR = PROJECT_ROOT / "dist"
ARTIFACT_PATH = DIST_DIR / "opslens-kev-ingestion.zip"
...
def copy_application_source() -> None:
    """Copy only KEV ingestion runtime source into the Lambda package."""
...
def main() -> None:
    """Build and report the KEV ingestion Lambda deployment artifact."""
    prepare_directories()
